...
//weights SRAM interface                                                       
  ...
  begin
    ...
    begin
      ...
      //input_mem.loadInitFile($sformatf("0_input_sram_464.mem"));   // e.g., 0_input_sram_464.mem, 1_input_sram_464.mem
      //weight_mem.loadInitFile($sformatf("0_weight_sram_464.mem")); // e.g., 0_weight_sram_464.mem, 1_weight_sram_464.mem
  
    $readmemh($sformatf("%0d_input_sram_%s.mem", j, class_name), input_mem.mem);  // Load the input SRAM data
    $readmemh($sformatf("%0d_weight_sram_%s.mem", j, class_name), weight_mem.mem); // Load the weight SRAM data
